...
create_generated_clock -name matmul_fast_clk [get_pins matmul_fast_clock.u_matmul_mmcm/CLKOUT0]

set_clock_groups -asynchronous -group [get_clocks cpu_clk] -group [get_clocks sys_clk]
set_clock_groups -asynchronous -group [get_clocks matmul_fast_clk] -group [get_clocks sys_clk]
set_clock_groups -asynchronous -group [get_clocks matmul_fast_clk] -group [get_clocks cpu_clk]
