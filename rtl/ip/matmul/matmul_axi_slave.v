                ...
                DMA_WRITE_W: begin
                    if (!m_wvalid) begin
                        ...
                        if (dma_last_write) begin
                            ...
                            dma_write_data <= dma_write_slot ? c_regs_alt[dma_write_word + 6'd1] : c_regs[dma_write_word + 6'd1];
                            m_wdata <= dma_write_slot ? c_regs_alt[dma_write_word + 6'd1] : c_regs[dma_write_word + 6'd1];
